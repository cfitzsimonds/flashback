...
if ($Run.ToLower() -eq "y")
{
    ...
    $username = 'Chris.Fitzsimonds@accidentfund.com'
    $password = 'RightP@ss8'
    ...
    {
        #Group
        Apply-PnPProvisioningTemplate -Path "D:\OneDrive - Rightpoint\_code\AFGroup\Collaboration\deployment\provisioning\templates\TeamSiteBaseGroup.xml"
        Apply-PnPProvisioningTemplate -Path "D:\OneDrive - Rightpoint\_code\AFGroup\Collaboration\deployment\provisioning\templates\TeamSiteHomePageGroup.xml"
    }
    else
    {
        #No group
        Apply-PnPProvisioningTemplate -Path "D:\OneDrive - Rightpoint\_code\AFGroup\Collaboration\deployment\provisioning\templates\TeamSiteBaseNoGroup.xml"
        Apply-PnPProvisioningTemplate -Path "D:\OneDrive - Rightpoint\_code\AFGroup\Collaboration\deployment\provisioning\templates\TeamSiteHomePageNoGroup.xml"
    }
    ...
    Write-Host "AFG team site provisioning complete" -ForegroundColor Green
